package com.sukabumikota.sipajarsurveyor.maps;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener, PermissionsListener {
    ...
    String id1, nama1,datalong, datalat;
    Double namawilayah, lo, la;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nama1 = intent.getStringExtra("nama_wilayah");
        datalong = intent.getStringExtra("longitude");
        datalat = intent.getStringExtra("latitude");

        la = Double.parseDouble(datalat);
        lo = Double.parseDouble(datalong);
...
// Call this method with Context from within an Activity
    ...
    public boolean onMapClick(@NonNull LatLng point) {
        ...
        Point destinationPoint = Point.fromLngLat(lo,la);
